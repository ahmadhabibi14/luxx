...
<div
  class="mx-5 md:mx-0 flex flex-row justify-center items-center h-full w-full gap-28 text-slate-950"
>
  ...
  <div class="w-[450px] bg-white p-6 rounded-xl drop-shadow-lg flex flex-col gap-3">
    <header>
      ...
      <p class="text-center text-sm text-slate-700 mt-1.5">
        Welcome! Please enter your details
      </p>
    </header>
    {#if isError === true}
      <div class="w-full h-fit p-2 rounded-md flex flex-row justify-center gap-2 items-center bg-red-500 text-white">
